              ...
              >
                ...
                <div className={`hidden md:flex items-start gap-8 ${
                  ...
                  <motion.div
                    ...
                    className={`w-[calc(50%-100px)] bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 backdrop-blur-sm p-8 rounded-2xl shadow-xl border-2 border-gray-200 dark:border-gray-700 relative z-10 overflow-hidden ${
