...
export default function CurrentActivity({ activity, visitorCount, loading }: CurrentActivityProps) {
  if (loading) {
    return (
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="inline-flex items-center gap-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow"
